      ...
      <div className="min-h-screen grid lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <section className="flex items-center justify-center px-5 py-10 sm:px-8">
          <div className="w-full max-w-md text-center">
            <div className="w-20 h-20 mx-auto rounded-full bg-[var(--color-primary-600)] flex items-center justify-center">
              <Check
                size={36}
                strokeWidth={1.7}
            ...
            <p className="mt-4 text-[var(--color-text-secondary)] leading-7">
            ...
            <div className="mt-8 bg-white border border-[var(--color-primary-600)]/5 rounded-2xl p-5 text-left shadow-sm">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[var(--color-surface-2)] flex items-center justify-center">
                  <Check size={17} />
                </div>
            ...
            <Link
              ...
              className="mt-8 w-full h-13 rounded-xl bg-[var(--color-primary-600)] text-white font-medium flex items-center justify-center gap-2 hover:bg-[var(--color-primary-700)] transition"
            >
